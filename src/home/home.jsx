...
const Home_pelis = () => {
    ...
    const handleClick = (index) => {
        ...
        setSelectedMovie(peliculasData[index]);
    };
    ...
    const { imagenUrl, titulo } = filteredMovies[currentMovieIndex] || {};

    return (
        <div className="container_home">
            <nav className={`navigation ${isScrolled ? 'scrolled' : ''}`}>
                <div className="nav-left">
                    <Link to="/" className="logo_home">SUIZAFLIX</Link>
                ...
                <div className="nav-right">
                    ...
                    <div className="user-menu">
                        <img src={require('../images/usuario.png')} alt="Usuario" className="user-avatar" />
            ...
            >
                <div className="pelis_content">
                    <h2 className="pelis_title">{titulo}</h2>
                    <Link to={`/pelis/${selectedMovie?.id}`} className="play_button">
                        Reproducir
                    </Link>
                ...
                <div className="movie-carousel">
                    {filteredMovies.length > 0 ? (
                        filteredMovies.map((pelicula, index) => (
                            <div
                                key={pelicula.id}
                                className={`movie-item ${index === currentMovieIndex ? 'active' : ''}`}
